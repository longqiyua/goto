...
我们额外支持乱序搜索，**超模糊搜索**（这是我们的核心功能，具体技术细节请见对应文档），快捷绑定搜索，悬浮球等功能以提高移动设备的操作效率（详情请见"## Introduction to Examples of Core Functionality 核心功能例子介绍"）  
同时，附带**统计功能**  
（统计项包含：注册日期，使用天数，软件启动次数，输入字符数，总启动次数以及各软件启动次数的梯度统计图等等等等）    
以及通过激活码实现的**多端同步**功能  
